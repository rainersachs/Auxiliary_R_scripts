#Cost-free, open-source software under the GNU GPLv3 license. Comes with no warranty. Concerns radiogenic mouse HG tumorigenesis
#Written by Mark Ebert, Edward Huang, and Rainer Sachs, summer 2017.
#Scientists can download, use, and modify the software freely to test robustness of theory conclusions
